document.addEventListener('DOMContentLoaded', function () {
  ...
  function processNode(node) {
    if (node.nodeType === 3) {
      ...
      text = text.replace(/([А-ЯЁ])\.\s+([А-ЯЁ])\./g,'$1.\u00A0$2.')
                 .replace(/([А-ЯЁ])\.\s+([А-ЯЁ][а-яё]+)/g,'$1.\u00A0$2');
  ...
  document.querySelectorAll('.text-format')
